...
import org.ituns.framework.master.mvvm.fragment.MediaFragment;
import org.ituns.framework.master.tools.java.IList;

import java.util.HashMap;
import java.util.List;

public class WebBrowserFragment<T> extends MediaFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fw_fragment_browser_web, container, false);
        mTitleLayout = rootView.findViewById(R.id.title);
        mProgress = rootView.findViewById(R.id.progress);
        mWebView = rootView.findViewById(R.id.browser);
        return rootView;
    }
    ...
    private void initializeWebView(WebView webView) {
        ...
        setting.setAppCachePath(requireContext().getCacheDir().getAbsolutePath());//设置应用缓存文件的路径
